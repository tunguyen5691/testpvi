        ...
        < div className="i-head">
         ...
         <div className="i-body">
          <div className="progressBar">
              <ProgressBar percentage="sixtyseven "/>
            </div>
            <div className="info">
              <BlockTitle text="KIỂM TRA LẠI THÔNG TIN"  size="md"/>
              <div className="infoContent">
                  <div className="bl">
                    ...
                    <div className="item email">Email: <span>nguyevawn@gmail.com</span></div>
                  </div>
                  <div className="bl">
                  ...
                  <div className="bl policy" >
                      <a href="#!" onClick={openModal}>Điều khoản và điều kiện sử dụng</a>
                  </div>
              </div>
            </div>
         </div>
         <div className="totalPrice">
           <span>480.700</span> VNĐ
         </div>
         <ButtonFoatBottom BtnShow="twoButton" btnTextNext="THANH TOÁN" btnTextPrev="CHỈNH SỬA" LinkPrev="/insurrancestep2a" LinkNext="/insurrancestep2c"/>
        </InsurranceStep>
    </div>
  )
}

export default Insurrancestep2bPage
