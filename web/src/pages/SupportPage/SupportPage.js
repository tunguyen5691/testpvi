...
const SupportPageStyle = styled.div`
  .welcomeText {
    margin-bottom: 24px;
    h4 {
      font-weight: bold;
...
const SupportPage = () => {
  ...
  return (
      ...
      <Modal className="alert"
        ...
        <div className="md-content">
          <div className="md-head">
            <h4>Mở tài khoản CTV</h4>
            <CloseButton  onClick={closeModal2}/>
          </div>
          <div className="md-body">

                <p>Bạn vui lòng gửi các thông tin CTV vào mail <span className="colorPrimary" >cskh.pvi@gmail.com</span> để được hỗ trợ mở CTV</p>
                <p className="left">1. Họ tên</p>
                <p className="left">2. Địa chỉ nhà </p>
                <p className="left">3. Địa chỉ email</p>
                <p className="left">4. Tên ngân hàng</p>
                <p className="left">5. Chi nhánh ngân hàng</p>
                <p className="left">6. Tên hưởng thụ (Tên TK ngân hàng)</p>
                <p className="left">7. Số tài khoản ngân hàng</p>
                <p className="left">8. Hình chụp CMND (2 mặt)</p>
                <ButtonStyle >
                    <div className="btn close" onClick={closeModal2}>
                      <Button btnText="Đóng" type="secondary" />
                    </div>
                    <div className="btn accept">
                      <Button btnText="Gửi mail"/>
                    </div>
                </ButtonStyle>
            </div>
        </div>
    ...
    <Modal
        ...
        >
        <div className="md-head">
          <Title titleType="" titleText="CHÍNH SÁCH CÔNG TY "></Title>
      ...
      <SupportPageStyle>
        <div className="i-head">
          ...
          <div className="welcomeText">
              <h4>XIN CHÀO</h4>
              <p>Bạn vui lòng chọn hình thức hỗ trợ bên dưới</p>
          </div>
        </div>
        <div className="i-body">
            <div className="card"  style={{ marginBottom: "16px"}}>
                <CardSp iconUrl="src/assets/images/Money2.svg" title="Hotline" value="0888 54 54 58" color="black"/>
            </div>
            <div className="card"  style={{ marginBottom: "16px"}}>
                <CardSp iconUrl="src/assets/images/Mail.svg" title="Hợp tác bán hàng" value="cskh.pvi@gmail.com" color="black"/>
            </div>
            <div className="card"  style={{ marginBottom: "16px"}}>
                <CardSp iconUrl="src/assets/images/HomePrimary.svg" title="Trung tâm bồi thường" value="1900 54 54 58" color="black"/>
            </div>
            <div className="card"  style={{ marginBottom: "16px"}} onClick={openModal2}>
                <CardSp iconUrl="src/assets/images/Team1.svg" title="Yêu cầu" value="Mở tài khoản CTV" color="black"/>
            </div>
            <div className="card"  style={{ marginBottom: "16px"}} onClick={openModal}>
                <CardSp iconUrl="src/assets/images/File2.svg" title="Công Ty" value="Bảo Hiểm PVI Thống Nhất" color="black"/>
            </div>
        </div>
      </SupportPageStyle>
    <NavigationBar status="support"/>
    </div>
  )
}
